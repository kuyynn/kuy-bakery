...
import { User, Phone, MapPin, Info, Clock, Star, Award, LogOut } from 'lucide-react-native';
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={[styles.menuItem, styles.lastMenuItem]} onPress={handleLogout}>
            <View style={styles.menuIconContainer}>
              <LogOut size={24} color="#d4850c" />
            </View>
            <View style={styles.menuContent}>
              <Text style={styles.menuText}>Logout</Text>
              <Text style={styles.menuSubtext}>Keluar dari akun</Text>
            </View>
          </TouchableOpacity>
        </View>
